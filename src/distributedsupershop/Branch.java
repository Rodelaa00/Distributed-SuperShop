...
public class Branch extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(92, 105, 350, -1));
        ...
        getContentPane().add(branchList, new org.netbeans.lib.awtextra.AbsoluteConstraints(92, 142, 203, -1));

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("DETAILED INFO");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(92, 212, 253, 21));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(92, 246, 441, 152));
        ...
        getContentPane().add(editButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 405, 110, -1));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(355, 143, -1, 20));
        ...
        getContentPane().add(createButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(339, 405, -1, -1));
        ...
        getContentPane().add(backButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(92, 405, -1, -1));
        ...
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 40, 221, 80));

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/loc_icon.png"))); // NOI18N
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 0, 110, 100));
